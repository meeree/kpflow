...
from analysis_utils import ping_dir, load_checkpoints, import_checkpoint, torch_to_np, np_to_torch
...
if __name__ == '__main__':
    ...
    task = CustomTaskWrapper(args.task_str, 200, use_noise = True, n_samples = 200, T = 90)
    inputs, targets = task()
    ...
    for ch in checkpoints:
        model = Model(input_size = 3, output_size = 3, rnn=nn.GRU if args.model == 'gru' else nn.RNN, hidden_size = 256)
